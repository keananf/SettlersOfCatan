...
public interface IAI 
{
    ...
    /**
     * Given this valid edge placement, analyse if this is a good road placement based on the game state.
    ...
    /**
     * Given this valid node placement, analyse if this is a good settlement placement based on the game state.
    ...
    /**
     * Given this valid hex placement, analyse if this is a good robber placement based on the game state.
     *
    ...
    /**
     * Given this valid dev card, analyse if this is a good play based on the game state.
     *
    ...
    /**
     * Given this valid trade possibility, analyse if this is a good trade based on the game state.
     *
    ...
    /**
     * If a discard request has gotten here, it is necessary. Assign the resources in turn.
     *
     * @param turn the given trade turn, with no trade information
     ...
     *
     * Rank based on which resource the player has the least of (or least access to?).
    ...
    /**
     * If this method is called, a trade response is required. Rank the potential response to this trade.
     *
     * The list of potential moves this turn will ONLY be
     * two trade responses: this and another with the opposite response.
