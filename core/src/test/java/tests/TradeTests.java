...
public class TradeTests extends TestHelper
{
	...
	@Test
	public void portDoubleTradeTest()
			throws IllegalTradeException, IllegalPortTradeException, CannotAffordException, IllegalBankTradeException,
			CannotBuildRoadException, RoadExistsException, SettlementExistsException, BankLimitException
	{
		Port port = game.getGrid().ports.get(0);
	...
	public void tradePhaseTest() throws SettlementExistsException, IOException, BankLimitException
	{
		...
		server.processMessage(Messages.Message.newBuilder()
